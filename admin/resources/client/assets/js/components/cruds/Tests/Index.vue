...
import DatatableBgImageField from './dtmodules/DatatableBgImageField'
    ...
    data() {
        return {
            columns: [
                ...
                { title: 'Category id', field: 'category', tdComp: DatatableSingle },
                { title: 'Title', field: 'title', sortable: true },
                { title: 'Main image', tdComp: DatatableMainImageField, sortable: false },
                { title: 'Bg image', tdComp: DatatableBgImageField, sortable: false },
